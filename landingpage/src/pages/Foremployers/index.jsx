              ...
              <div className="ml-[86px] flex w-[65%] items-center justify-between gap-5 md:ml-0 md:w-full md:flex-col">
                <div className="flex flex-wrap items-center gap-1 rounded-tr-[5px] bg-deep_purple-600 pr-1.5">
                  <Heading
                    size="lg"
                    as="h2"
                    className="rounded-[5px] border border-solid border-deep_purple-600 pl-[6px] !font-outfit !text-[35.5px] tracking-[-0.71px] !text-white-A700_01"
                  >
                    <span className="bg-white-A700_01 text-deep_purple-600 p-2px">r</span>
                    <span className="tracking-[2.84px]  bg-white-A700_01 text-deep_purple-600">e</span>
