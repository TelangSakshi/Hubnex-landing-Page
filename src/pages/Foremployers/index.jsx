...
export default function ForemployersPage() {
  return (
    <>
      <Helmet>
        <title>Sakshi's Application1</title>
      ...
      <div className="w-full bg-white-A700 pb-[1235px] md:pb-5">
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-end self-stretch bg-gray-100 pb-2.5">
            <header className="flex items-center justify-between gap-5 self-stretch p-[34px] md:flex-col sm:p-5">
              <div className="ml-[86px] flex w-[65%] items-center justify-between gap-5 md:ml-0 md:w-full md:flex-col">
                <div className="flex flex-wrap items-center gap-1 rounded-tr-[7px] bg-deep_purple-600 pr-1.5">
                  <Heading
                    size="lg"
                    as="h2"
                    className="rounded-[6px] border border-solid border-deep_purple-600 pl-[0px] !font-outfit !text-[35.5px] tracking-[-0.71px] !text-white-A700_01"
                  >
                    <span className="bg-white-A700_01 text-deep_purple-600 p-3px" >r</span>
                    <span className="tracking-[2.84px] text-deep_purple-600 bg-white-A700_01 ">e</span>
              ...
              <div className="mr-[86px] flex gap-[17px] md:mr-0">
                <Button
                  size="sm"
                  shape="round"
          ...
          <div className="flex flex-col items-center gap-[74px] self-stretch bg-white-A700 p-14 md:gap-[55px] md:p-5 sm:gap-[37px]">
            ...
            <div className="mx-auto flex w-full max-w-[1197px] gap-[49px] md:flex-col">
              <div className="flex w-full flex-col items-center justify-center rounded-[10px] bg-gray-100 p-[30px] shadow-lg sm:p-5">
                ...
                <div className="mt-[46px] flex flex-col gap-[62px] self-stretch sm:gap-[31px]">
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-2">
                      <CheckBox
                        ...
                        id="checkmark2"
                        className="gap-2.5 py-px pr-[19px] text-left text-base text-gray-700"
                      />
                      <CheckBox
                        name="checkmark_one"
                        label="Unlimited job postings"
                        id="checkmarkone2"
                        className="gap-2.5 py-px pr-[35px] text-left text-base text-gray-700 sm:pr-5"
                      />
                  ...
                  <Button shape="round" className="w-full !text-white-A700_01 !shadow-3xl sm:px-5">
                    Get Started
                  </Button>
                </div>
              </div>
              <div className="flex w-full flex-col items-start rounded-[10px] bg-deep_purple-600 pb-[30px] pl-[30px] shadow-lg sm:pb-5 sm:pl-5">
                ...
                <div className="ml-[5px] mt-[46px] flex w-[90%] flex-col gap-[62px] md:ml-0 md:w-full sm:gap-[31px]">
                  <div className="flex flex-col gap-5">
                    <Text
                      size="lg"
                      as="p"
                    ...
                    <div className="flex flex-col gap-2">
                      <CheckBox
                        ...
                        label="10 interview-ready candidates"
                        id="checkmark1"
                        className="gap-2.5 py-px pr-[19px] text-left text-base text-deep_purple-50"
                      />
                      <CheckBox
                        name="checkmark_one"
                        label="Unlimited job postings"
                        id="checkmarkone1"
                        className="gap-2.5 py-px pr-[35px] text-left text-base text-deep_purple-50 sm:pr-5"
                      />
                      <div className="flex items-start gap-2.5">
                        <Img
                  ...
                  <Button color="gray_100" shape="round" className="w-full font-medium !shadow-3xl sm:px-5">
                    Get Started
                  </Button>
                </div>
              </div>
          ...
          <div className="flex flex-col items-start self-stretch bg-white-A700 py-[66px] pl-[66px] pr-14 md:p-5">
            ...
            <div className="mx-auto mb-[146px] mt-[83px] flex w-full max-w-[1198px] gap-6 self-center md:flex-col">
              <div className="flex w-full flex-col gap-[30px]">
                <div className="flex flex-col items-center gap-7 rounded-[16px] bg-deep_purple-50 p-3.5 shadow-xl">
                ...
                <div className="flex flex-col items-center justify-center gap-7 rounded-[16px] bg-deep_purple-50 p-[15px] shadow-xl">
              ...
              <div className="flex w-full flex-col gap-[30px]">
                <div className="flex flex-col items-center justify-center gap-[30px] rounded-[16px] bg-deep_purple-50 p-4 shadow-xl">
          ...
          <div className="self-stretch">
            <div className="flex flex-col items-center justify-center gap-12 bg-white-A700 px-14 py-[75px] md:p-5">
              ...
              <div className="mx-auto flex w-full max-w-[1192px] gap-5 md:flex-col">
                <div className="flex w-full flex-col gap-2.5 rounded-[16px] bg-gray-50_01 shadow-2xl">
                  <Img
            ...
            <div className="flex flex-col items-center bg-gray-100 px-14 py-[109px] md:p-5">
              ...
              <Text as="p" className="mt-[19px] w-[62%] text-center leading-[22px] !text-gray-900 md:w-full">
                We have Compiled the most commonly asked question about our Platform for your information and to enhance
                your overall experience.
              </Text>
              <div className="mb-12 mt-[74px] flex w-[64%] flex-col gap-4 md:w-full">
                <div className="flex flex-col items-center justify-center gap-[22px] rounded-[10px] border-2 border-solid border-deep_purple-600 p-4">
                  <div className="mx-auto mt-1 flex w-full max-w-[798px] items-center justify-between gap-5 self-stretch sm:flex-col">
                    <Text size="lg" as="p" className="!font-medium !text-gray-900">
                  ...
                  <Text as="p" className="w-[97%] !font-light leading-[22px] !text-gray-900 md:w-full">
                ...
                <div className="flex items-start justify-between gap-5 rounded-[10px] border-2 border-solid border-deep_purple-600 p-[17px]">
                  <Text size="lg" as="p" className="mb-[3px] ml-[11px] !font-medium !text-gray-900 md:ml-0">
                    How can I Get started with Rework AI?
                  </Text>
                  <Img
                    src="images/img_typcn_plus.svg"
                ...
                <div className="flex items-start justify-between gap-5 rounded-[10px] border-2 border-solid border-deep_purple-600 p-[17px]">
                  <Text size="lg" as="p" className="mb-[3px] ml-3 !font-medium !text-gray-900 md:ml-0">
                    How can I Get started with Rework AI?
                  </Text>
                  <Img
                    src="images/img_typcn_plus.svg"
